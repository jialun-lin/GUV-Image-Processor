...
%% ============================= 1) 路径与输出 =============================
Cfg.ND2Path = 'E:\GUV\GUV_Image_Analysis\Sample\20251224.nd2';
Cfg.OutRoot = 'E:\GUV\GUV_Image_Analysis\Out_ModularB_Clean\20251224';
...
%% ============================= 3) 读取设置（Series / Z / 通道） ===========
Cfg.Read = struct();
Cfg.Read.SelectXYs = [1];     % 例如 [2 5 10]；空=[]表示全跑
...
Cfg.Compute.Visualize.Enable = true;   % true=基于 AllResults 输出多张 png

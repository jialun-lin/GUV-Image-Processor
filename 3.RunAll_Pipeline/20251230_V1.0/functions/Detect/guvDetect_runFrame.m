...
[GUVData, ~] = guvDetect_buildDataStruct(I_norm, size(I_norm), innerMask, stats, DetectOpts, true);
...
if isfield(GUVData,'bboxes') && isfield(GUVData,'subMasks') && ~isempty(GUVData.subMasks)
    [bandMasks, memInt] = guvDetect_computeMemBandFromSubMasks(I_norm, GUVData.bboxes, GUVData.subMasks, DetectOpts);
